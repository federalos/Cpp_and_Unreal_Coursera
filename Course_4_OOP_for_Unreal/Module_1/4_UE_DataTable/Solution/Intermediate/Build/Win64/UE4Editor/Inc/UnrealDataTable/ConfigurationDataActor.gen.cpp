...
#include "UnrealDataTable/ConfigurationDataActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	UNREALDATATABLE_API UClass* Z_Construct_UClass_AConfigurationDataActor_NoRegister();
	UNREALDATATABLE_API UClass* Z_Construct_UClass_AConfigurationDataActor();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AConfigurationDataActor_Statics::Class_MetaDataParams[] = {
		...
		{ "ToolTip", "A configuration data actor" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AConfigurationDataActor, 783213979);
	template<> UNREALDATATABLE_API UClass* StaticClass<AConfigurationDataActor>()
	{
		return AConfigurationDataActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AConfigurationDataActor(Z_Construct_UClass_AConfigurationDataActor, &AConfigurationDataActor::StaticClass, TEXT("/Script/UnrealDataTable"), TEXT("AConfigurationDataActor"), false, nullptr, nullptr, nullptr);
